...
<c:if test="${staff.username!=null}">
    ...
    <br/>
    <div class="contentDangKi" style="display: grid; grid-template-columns: 200px 1fr ">
        <div class="leftDangKi">
            <img src="<c:url value="/images/${staff.hinhAnh}"/>" style="width: 200px;">
        </div>
        <div class="rightDangKi">
